    ...
    <footer className="bg-black text-white py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-blue-500 text-xl font-bold">MCR</span>
                <span className="text-white text-xs">MINISTERIAL COMFORT AND RENEWAL</span>
              </div>
            </div>
          ...
          {/* Initiative */}
          <div>
            <h3 className="text-lg font-semibold mb-4">INITIATIVE</h3>
            <ul className="space-y-2">
              <li>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm">
                  PLOT PC, RD 8B (BUSINESS SECTION) VICTORIA GARDEN CITY, LAGOS, NIGERIA.
                </span>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <span className="text-sm">+234-1-7317138</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 pt-8 mt-8 text-center">
          <p className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-8 max-w-3xl mx-auto">
